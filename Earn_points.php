...
<section class="Profile_pagess sec_arr coupons_listPage earn_points">
    <div class="row" id="body-row">
        ...
        <!-- MAIN -->
        <div class="col p-4">
            <div class="row ear_pts">
                <div class="col-md-10 ">
                    <div class="view ">
                        <img src="assets/imgs/token.png" alt="">
                    </div>
                    <span class="personal ml-3 ">Earn <span class="detail">Points</span> </span>
                </div>
                <div class="col-md-2">
                    <div class="view ">
                ...
                <div class="container current_dealSBox ">
                    <div class="row">
                        ...
                        <div class="col-md-12 p-5 ">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <span class="avb_pt">Available <span class="points_av"> <br> Points</span></span>
                                </div>
                                <div class="col-md-4"><span class="eded">AED 500.00</span></div>
            ...
            <section class="currnt_deals earnedd ">
                <div class="container current_dealSBox ">
                    <div class="row">

                        <div class="col-md-12 p-5 ">

                            <div class="row earnd_pt">
                                <div class="col-md-10">
                                    <span>Earned through purchases </span>
                                </div>
                                <div class="col-md-2"><span class=""> 0</span></div>
                                <div class="col-md-10">
                                    <span> Earned through referrals </span>
                                </div>
                                <div class="col-md-2"><span class=""> 0</span></div>

                                <div class="col-md-10">
                                    <span style="color:#F22806;">Total Earned</span>
                                </div>
                                <div class="col-md-2">
                                    <span class=""> 0</span>
                                </div>
                                ...
                                <div class="col-md-10">
                                    <span style="color:#F22806;">Total Spent  </span>
                                </div>
                                <div class="col-md-2">
                                    <span class=""> 0</span>
                                </div>
